...
typedef enum
{
	SDHC_Flag_CLSL,                 //!< Command line single level
	SDHC_Flag_CINS,                 //!< Card inserted
	SDHC_Flag_BREN,                 //!< Buffer Read Enable
	SDHC_Flag_BWEN,                 //!< Buffer Write Enable
	SDHC_Flag_RTA,                  //!< Read transfer active
	SDHC_Flag_WTA,                  //!< Write transfer active
	SDHC_Flag_SDOFF,                //!< SD clock gated off internaly
	SDHC_Flag_PEROFF,               //!< SDHC gate clock off
	SDHC_Flag_DLA,                  //1< Data line active
	SDHC_Flag_CDIHB,                //!< Command inhibit(DAT)
	SDHC_Flag_CIHB,                 //!< Command inhibit (CMD)
}SDHC_Flag_TypeDef;

typedef enum
{
	SDHC_IT_DMAE,                  //!< DMA Err
	SDHC_IT_AC12E,                 //!< Auto CMD12 Err
	SDHC_IT_DEBE,                  //!< Data End Bit Err
	SDHC_IT_DCE,                   //!< Data CRC Err
	SDHC_IT_DTOE,                  //!< Data Timeout Err
	SDHC_IT_CIE,                   //!< Command index Err
	SDHC_IT_CEBE,                  //!< Command end bit error
	SDHC_IT_CC,                    //!< Command Complete 
	SDHC_IT_TC,                    //!< Transfer Complete
	SDHC_IT_BGE,                   //!< Block Gap Event 
	SDHC_IT_DINT,                  //!< DMA interrupt
	SDHC_IT_BWR,                   //!< Buffer Read Ready
	SDHC_IT_CINS,                  //!< Card Insertion 
	SDHC_IT_CRM,                   //!< Card Removal
	SDHC_IT_CINT,                  //!< Card Interrupt
}SDHC_IT_TypeDef;
...
void SDC_ITConfig(SDHC_Type* SDx, SDHC_IT_TypeDef SD_IT, FunctionalState NewState);
