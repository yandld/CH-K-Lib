...
#define MCGOUT_TO_BUS_DIVIDER            ((((SIM->CLKDIV1 & SIM_CLKDIV1_OUTDIV4_MASK)>>SIM_CLKDIV1_OUTDIV4_SHIFT) + 1)*MCGOUT_TO_CORE_DIVIDER)
#define MCGOUT_TO_FLASH_DIVIDER          MCGOUT_TO_BUS_DIVIDER
