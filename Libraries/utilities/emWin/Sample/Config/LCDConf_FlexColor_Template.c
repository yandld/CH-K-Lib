...
{
    // ... TBD by user
	*(volatile uint16_t*)ILI9320_CMD_BASE = Data;
}
...
static void LcdWriteDataMultiple(U16 * pData, int NumItems) 
{
	...
	{
		// ... TBD by user
		*(volatile uint16_t*)ILI9320_DATA_BASE = *pData++;
	}
}
...
static void LcdReadDataMultiple(U16 * pData, int NumItems) 
{
	...
	{
		// ... TBD by user
		*pData++ = *(volatile uint16_t*)ILI9320_DATA_BASE ;
	}
}
